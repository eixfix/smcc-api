...
const check_endpoint_dto_1 = require("./dto/check-endpoint.dto");
const security_service_1 = require("./security.service");
let SecurityController = class SecurityController {
    constructor(securityService) {
        this.securityService = securityService;
    }
    checkEndpoint(payload, user) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [check_endpoint_dto_1.CheckEndpointDto, Object]),
    __metadata("design:returntype", void 0)
], SecurityController.prototype, "checkEndpoint", null);
