...
export declare class OrganizationService {
    ...
    create(payload: CreateOrganizationDto): Promise<CreatedOrganization>;
    update(id: string, payload: UpdateOrganizationDto, user: AuthenticatedUser): Promise<Organization>;
